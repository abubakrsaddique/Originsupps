            ...
            <div className="w-[370px] lg:max-w-[300px] mob:max-w-[170px]">
              ...
              <div className="mt-[15px]">
                <div className="flex items-start justify-between">
                  <p className="font-poppins text-primary text-[22px] mob:text-[14px] font-medium">
                    {product.title}
                  </p>
                  <p className="font-poppins text-primary text-[24px] mob:text-[16px] font-semibold leading-6 shrink-0">
                    ${product.price}
                  </p>
                </div>
